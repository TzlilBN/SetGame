...
class TableTest {
    ...
    private void placeTokenAndAssert()
    {
    ...
    void placeCard_AllSlotsAreFilled() throws InterruptedException {
     ...
     @Test
    void removeCard_AllSlotsAreFilled_checkTheDeletedCard() throws InterruptedException {
        fillAllSlots();
        table.removeCard(0);
        assertEquals(null, table.slotToCard[0]);
         ...
         @Test
    void removeCard_AllSlotsAreFilled_CountTheRemainingCards() throws InterruptedException {
        fillAllSlots();
        table.removeCard(0);
        assertEquals(slotToCard.length-1, table.countCards());
    }
